...
public class ItemSelectorPanel extends JPanel implements KeyListener {
    ...
    public ItemSelectorPanel(Inventory inventory, Equipments equipments, GameFrame parent) {
    ...
    public void paint(Graphics g) {
        ...
        g.drawString("Inventory", 200, 100);
    ...
    public void keyReleased(KeyEvent e) {
        ...
        if (e.getKeyCode() == KeyEvent.VK_D) {
            ...
            if (inventory.getItems().size() != 0) {
                selectedItem = inventory.getItems().get(currentNumberSelected + (currentPage - 1) * 10);
                if (!(selectedItem instanceof Unusable)) {
            ...
            if (inventory.getItems().size() != 0) {
                Item deletedItem = inventory.getItems().get(currentNumberSelected + (currentPage - 1) * 10);
                if (!(deletedItem instanceof Unusable)) {
                    if (deletedItem instanceof Stackable) {
                        inventory.getItems().remove(deletedItem);
                    } else {
